...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('issues_ratings', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('art', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('story', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('overall', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('notes', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('issues', ['Ratings'])


    def backwards(self, orm):
        # Deleting model 'Ratings'
        db.delete_table('issues_ratings')
