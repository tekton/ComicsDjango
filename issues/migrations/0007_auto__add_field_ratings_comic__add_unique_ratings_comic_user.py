...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ratings.comic'
        db.add_column('issues_ratings', 'comic',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['issues.Comic'], null=True, blank=True),
                      keep_default=False)

        # Adding unique constraint on 'Ratings', fields ['comic', 'user']
        db.create_unique('issues_ratings', ['comic_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Ratings', fields ['comic', 'user']
        db.delete_unique('issues_ratings', ['comic_id', 'user_id'])

        # Deleting field 'Ratings.comic'
        db.delete_column('issues_ratings', 'comic_id')
