...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserRating.story'
        db.alter_column(u'ratings_userrating', 'story', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'UserRating.art'
        db.alter_column(u'ratings_userrating', 'art', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'UserRating.overall'
        db.alter_column(u'ratings_userrating', 'overall', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'UserRating.story'
        db.alter_column(u'ratings_userrating', 'story', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'UserRating.art'
        db.alter_column(u'ratings_userrating', 'art', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'UserRating.overall'
        db.alter_column(u'ratings_userrating', 'overall', self.gf('django.db.models.fields.IntegerField')(null=True))
