...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ratings_userrating', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('comic', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['issues.Comic'])),
            ('overall', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('art', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('story', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('ratings', ['UserRating'])


    def backwards(self, orm):
        # Deleting model 'UserRating'
        db.delete_table('ratings_userrating')
    ...
    models = {
        ...
        'ratings.userrating': {
            ...
            'art': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'comic': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['issues.Comic']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'overall': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'story': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
