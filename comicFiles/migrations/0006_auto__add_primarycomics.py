...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PrimaryComics'
        db.create_table('comicFiles_primarycomics', (
            ...
            ('comicFile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['comicFiles.ComicFile'])),
        ))
        db.send_create_signal('comicFiles', ['PrimaryComics'])


    def backwards(self, orm):
        # Deleting model 'PrimaryComics'
        db.delete_table('comicFiles_primarycomics')
    ...
    models = {
        ...
        'comicFiles.primarycomics': {
            'Meta': {'object_name': 'PrimaryComics'},
