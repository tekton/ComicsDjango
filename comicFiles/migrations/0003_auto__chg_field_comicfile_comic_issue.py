...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ComicFile.comic_issue'
        db.alter_column('comicFiles_comicfile', 'comic_issue', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'ComicFile.comic_issue'
        db.alter_column('comicFiles_comicfile', 'comic_issue', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
