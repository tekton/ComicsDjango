...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'PrimaryComics', fields ['comicFile', 'series', 'comic']
        db.create_unique('comicFiles_primarycomics', ['comicFile_id', 'series_id', 'comic_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'PrimaryComics', fields ['comicFile', 'series', 'comic']
        db.delete_unique('comicFiles_primarycomics', ['comicFile_id', 'series_id', 'comic_id'])
