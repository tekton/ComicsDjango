...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TransferRoot'
        db.create_table('comicFiles_transferroot', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('uri', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('comicFiles', ['TransferRoot'])


    def backwards(self, orm):
        # Deleting model 'TransferRoot'
        db.delete_table('comicFiles_transferroot')
