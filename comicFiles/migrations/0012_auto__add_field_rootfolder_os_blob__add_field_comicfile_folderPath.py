...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RootFolder.os_blob'
        db.add_column(u'comicFiles_rootfolder', 'os_blob',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ComicFile.folderPath'
        db.add_column(u'comicFiles_comicfile', 'folderPath',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RootFolder.os_blob'
        db.delete_column(u'comicFiles_rootfolder', 'os_blob')

        # Deleting field 'ComicFile.folderPath'
        db.delete_column(u'comicFiles_comicfile', 'folderPath')
    ...
    models = {
        ...
        u'comicFiles.comicfile': {
            ...
            'folderPath': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'comicFiles.rootfolder': {
            ...
            'os_blob': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
