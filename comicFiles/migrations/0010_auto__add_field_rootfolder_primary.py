...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RootFolder.primary'
        db.add_column(u'comicFiles_rootfolder', 'primary',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RootFolder.primary'
        db.delete_column(u'comicFiles_rootfolder', 'primary')
