...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ComicFile.thumbnail'
        db.add_column('comicFiles_comicfile', 'thumbnail',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ComicFile.thumbnail'
        db.delete_column('comicFiles_comicfile', 'thumbnail')
