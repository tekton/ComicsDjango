...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'PullList', fields ['series', 'user']
        db.create_unique('PullLists_pulllist', ['series_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'PullList', fields ['series', 'user']
        db.delete_unique('PullLists_pulllist', ['series_id', 'user_id'])


    models = {
        'PullLists.pulllist': {
            'Meta': {'unique_together': "(('user', 'series'),)", 'object_name': 'PullList'},
