...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PullList'
        db.create_table('PullLists_pulllist', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('series', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['issues.Series'])),
        ))
        db.send_create_signal('PullLists', ['PullList'])


    def backwards(self, orm):
        # Deleting model 'PullList'
        db.delete_table('PullLists_pulllist')


    models = {
        'PullLists.pulllist': {
            'Meta': {'object_name': 'PullList'},
